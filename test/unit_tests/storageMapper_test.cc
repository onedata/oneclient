...
TEST_F(StorageMapperTest, AddAndGet) {
    ...
    EXPECT_EQ("arg0", boost::any_cast<std::string>(ret1.second.storageHelperArgs["srv_arg0"]));
    EXPECT_EQ("arg3", boost::any_cast<std::string>(ret2.second.storageHelperArgs["srv_arg1"]));
}
