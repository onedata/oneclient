...
const boost::filesystem::path &System::userDataDir() const
{
    return m_userDataDir;
}

const boost::filesystem::path &System::userHome() const { return m_userHome; }

const std::string &System::clientName() const { return m_clientName; }
